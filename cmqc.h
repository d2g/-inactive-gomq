...
#define _int64 long long 
 ...
 #define MQGMO_BROWSE_HANDLE (          \
         MQGMO_BROWSE_FIRST         |   \
         MQGMO_UNMARKED_BROWSE_MSG  |   \
         MQGMO_MARK_BROWSE_HANDLE)

 #define MQGMO_BROWSE_CO_OP (           \
         MQGMO_BROWSE_FIRST         |   \
         MQGMO_UNMARKED_BROWSE_MSG  |   \
...
/* The property below is undocumented and only used internally */
 #define MQIMPO_RETURN_HIDDEN_PROPERTIES          0x80000000
 ...
 #define MQSCO_CURRENT_VERSION 2
...
/* %%#con$ params ValueLength - mqsetmp */
 ...
 #define MQCMDL_CURRENT_LEVEL 701
 ...
 /****************************************************************/
 /* MQCBC structure - Call back context                          */
 /****************************************************************/
 ...
 struct tagMQCBC {
   ...
   MQLONG    Flags;           /* Flags containing information about
                                 this consumer */
   /* Ver:1 */
   MQLONG    ReconnectDelay;  /* Number of milliseconds before reconnect
                                 attempt */
   /* Ver:2 */
 };
 ...
 /****************************************************************/
 /* MQCBD structure - Call back data descriptor                  */
 /****************************************************************/
 ...
 struct tagMQSCO {
   ...
   /* Ver:1 */
   MQLONG     KeyResetCount;      /* Number of unencrypted bytes
                                     sent/received before secret key
                                     is reset */
   MQLONG     FipsRequired;       /* Using FIPS-certified algorithms */
   /* Ver:2 */
 };
 ...
 void MQENTRY MQINQMP (
   MQHCONN   Hconn,         /* I: Connection handle */
   MQHMSG    Hmsg,          /* I: Message handle */
   PMQVOID   pInqPropOpts,  /* IO: Options that control the action of
                               MQINQMP */
   PMQVOID   pName,         /* I: Property name */
   PMQVOID   pPropDesc,     /* O: Property descriptor */
   PMQLONG   pType,         /* IO: Property data type */
   MQLONG    ValueLength,   /* IL: Length in bytes of the Value
                               area */
